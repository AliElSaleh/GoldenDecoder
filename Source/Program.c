...
{
    {.Key = KEY_ONE,         .LeftImage.Name = "Calibration Circle",                    .RightImage.Name = "School of Fish",                            .LeftImage.SampleOffset = 1375283,  .RightImage.SampleOffset = 1490087,  .LeftImage.ColorChannel = Mono,  .RightImage.ColorChannel = Red,   .LeftImage.Source = "Jon Lomberg", .RightImage.Source = "David Doubilet", .RightImage.bPortrait = true, .LeftImage.SourceURL = "https://science.nasa.gov/image-detail/calibration-circle-31325346536-o/"},
    {.Key = KEY_TWO,         .LeftImage.Name = "Solar Location in the Milky Way",       .RightImage.Name = "School of Fish",                            .LeftImage.SampleOffset = 1905722,  .RightImage.SampleOffset = 1984822,  .LeftImage.ColorChannel = Mono,  .RightImage.ColorChannel = Green, .LeftImage.Source = "Frank Drake", .RightImage.Source = "David Doubilet", .RightImage.bPortrait = true, .LeftImage.OverrideParams = &(ScanTriggerThresholdParams){.FallThreshold = 0.0275f, .DebounceSamples = 3}, .LeftImage.Description = "Fixes the position of the Sun from the periods of fourteen pulsars.", .LeftImage.SourceURL = "https://science.nasa.gov/image-detail/solar-location-map-30992503150-o/"},
    {.Key = KEY_THREE,       .LeftImage.Name = "Math Definitions",                      .RightImage.Name = "School of Fish",                            .LeftImage.SampleOffset = 2446590,  .RightImage.SampleOffset = 2505754,  .LeftImage.ColorChannel = Mono,  .RightImage.ColorChannel = Blue,  .LeftImage.Source = "Frank Drake", .RightImage.Source = "David Doubilet", .RightImage.bPortrait = true, .LeftImage.SourceURL = "https://science.nasa.gov/image-detail/mathematical-definitions-30539954574-o/"},
    {.Key = KEY_FOUR,        .LeftImage.Name = "Physics Definitions",                   .RightImage.Name = "Tree Toad",                                 .LeftImage.SampleOffset = 2968481,  .RightImage.SampleOffset = 3033022,  .LeftImage.ColorChannel = Mono,  .RightImage.ColorChannel = Mono,  .LeftImage.Source = "Frank Drake", .RightImage.Source = "Dave Wickstrom", .LeftImage.Description = "Defining the units of time, length, and mass from the hydrogen atom.", .LeftImage.OverrideParams = &(ScanTriggerThresholdParams){.FallThreshold = 0.03f, .DebounceSamples = 2}, .LeftImage.SourceURL = "https://science.nasa.gov/image-detail/physical-unit-definitions-30554003853-o/"},
    {.Key = KEY_FIVE,        .LeftImage.Name = "Solar System Parameters 1",             .RightImage.Name = "Crocodile",                                 .LeftImage.SampleOffset = 3483550,  .RightImage.SampleOffset = 3546161,  .LeftImage.ColorChannel = Mono,  .RightImage.ColorChannel = Mono,  .LeftImage.Source = "Frank Drake", .RightImage.Source = "Peter Beard",    .LeftImage.Description = "Displaying the diameter, distance, mass, and rotation period of the Sun, Mercury, Venus, Earth and Mars.", .LeftImage.SourceURL = "https://science.nasa.gov/image-detail/solar-system-parameters-30554017073-o/"},
    {.Key = KEY_SIX,         .LeftImage.Name = "Solar System Parameters 2",             .RightImage.Name = "Eagle",                                     .LeftImage.SampleOffset = 3998630,  .RightImage.SampleOffset = 4051738,  .LeftImage.ColorChannel = Mono,  .RightImage.ColorChannel = Mono,  .LeftImage.Source = "Frank Drake", .RightImage.Source = "Donona, Taplinger Publishing Co.", .LeftImage.Description = "Cont. diameter, distance, mass, and rotation period of Jupiter, Saturn, Uranus, Neptune and Pluto.", .LeftImage.SourceURL = "https://science.nasa.gov/image-detail/solar-system-parameters-30992729550-o/"},
    ...
    {.Key = KEY_O,           .LeftImage.Name = "Chemical Definitions",                  .RightImage.Name = "Mountain Climber",                          .LeftImage.SampleOffset = 11130449, .RightImage.SampleOffset = 11125216, .LeftImage.ColorChannel = Mono,  .RightImage.ColorChannel = Mono,  .LeftImage.Source = "Frank Drake", .RightImage.Source = "Gaston Rebuffat", .LeftImage.Description = "Defines the five atoms of life as Bohr diagrams, and the four DNA bases drawn as structural formulas.", .LeftImage.SourceURL = "https://science.nasa.gov/image-detail/chemical-definitions-31218371762-o/"},
    {.Key = KEY_P,           .LeftImage.Name = "DNA Structure",                         .RightImage.Name = "Gymnast",                                   .LeftImage.SampleOffset = 11611579, .RightImage.SampleOffset = 11631241, .LeftImage.ColorChannel = Mono,  .RightImage.ColorChannel = Mono,  .LeftImage.Source = "Jon Lomberg", .RightImage.Source = "Philip Leonian; Sports Illustrated", .LeftImage.Description = "Builds the DNA double helix and fixes the two base pairs, A-T and G-S.", .RightImage.Description = "Cathy Rigby", .LeftImage.SourceURL = "https://science.nasa.gov/image-detail/dna-structure-31362211895-o/"},
    {.Key = KEY_A,           .LeftImage.Name = "DNA Structure (Magnified)",             .RightImage.Name = "Sprinters",                                 .LeftImage.SampleOffset = 12112408, .RightImage.SampleOffset = 12131300, .LeftImage.ColorChannel = Mono,  .RightImage.ColorChannel = Mono,  .LeftImage.Source = "Jon Lomberg", .RightImage.Source = "History of the Olympics, Picturepoint, London", .LeftImage.Description = "Magnifies the helix and shows it unzip and copy itself.", .RightImage.Description = "Valeriy Borzov of the U.S.S.R. in lead", .RightImage.Location = {"Olympiastadion, Munich", 48.1731f, 11.5468f}, .LeftImage.SourceURL = "https://science.nasa.gov/image-detail/dna-structure-magnified-light-hit-31362224015-o/", .RightImage.SourceURL = "https://science.nasa.gov/image-detail/sprinters-valeri-borzov-of-the-ussr-in-lead-history-of-the-olympics-31363259165-o/"},
    {.Key = KEY_S,           .LeftImage.Name = "Cell Division",                         .RightImage.Name = "Schoolroom",                                .LeftImage.SampleOffset = 12618348, .RightImage.SampleOffset = 12643425, .LeftImage.ColorChannel = Mono,  .RightImage.ColorChannel = Mono,  .LeftImage.Source = "Turtox/Cambosco", .RightImage.Source = "U.N. Photo", .RightImage.Description = "Japan", .LeftImage.Description = "A micrograph of cells in mitosis with the DNA helix inset for scale.", .RightImage.SourceURL = "https://science.nasa.gov/image-detail/schoolroom-30994523250-o/"},
